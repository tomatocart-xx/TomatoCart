...
?>
        ...
        <td valign="center"><?php echo osc_draw_input_field('products[' . $products_id_string . ']', $products['quantity'], 'size="4"'); ?></td>
        <td valign="center" align="right"><?php echo '<b>' . $osC_Currencies->displayPrice($products['final_price'], $products['tax_class_id'], $products['quantity']) . '</b>'; ?></td>
      </tr>
