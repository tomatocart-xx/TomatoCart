...
<div class="moduleBox">
  <span style="float: right;"> <h6> <?php echo $osC_Language->get('date_added') . '&nbsp;' . osC_DateTime::getShort($Qslips->value('date_added')) ; ?></h6></span>
  
  <h6> <?php echo $osC_Language->get('credit_slip_number') . '&nbsp;' . $Qslips->value('credit_slips_id');?> </h6>
