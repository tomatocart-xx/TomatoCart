...
<div class="moduleBox">
  <span style="float: right;"><h6> <?php echo $osC_Language->get('order_return_date_added') . ' ' . osC_DateTime::getShort($Qhistory->value('date_added')); ?></h6></span>
  
  <h6> <?php echo $osC_Language->get('order_return_number') . ' ' . $Qhistory->value('orders_returns_id') . ' (' . $Qhistory->value('orders_returns_status_name') . ')';?> </h6>
