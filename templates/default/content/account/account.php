...
<div class="moduleBox">
  ...
  <div class="content">
    <div style="float:left"><?php echo osc_image(DIR_WS_IMAGES . 'account_personal.gif', $osC_Language->get('my_account_title')); ?></div>

    <ul style="float:left;padding-left:40px;list-style-image: url(<?php echo osc_href_link(DIR_WS_IMAGES . 'arrow_green.gif', null, 'SSL'); ?>);">
...
<div class="moduleBox">
  ...
  <div class="content">
    <div style="float:left"><?php echo osc_image(DIR_WS_IMAGES . 'account_orders.gif', $osC_Language->get('my_orders_title')); ?></div>
...
<div class="moduleBox">
  ...
  <div class="content">
    <div style="float:left"><?php echo osc_image(DIR_WS_IMAGES . 'account_orders.gif', $osC_Language->get('my_wishlist_title')); ?></div>

    <ul style="float:left;padding-left:40px; list-style-image: url(<?php echo osc_href_link(DIR_WS_IMAGES . 'arrow.png', null, 'SSL'); ?>);">
...
<div class="moduleBox">
  ...
  <div class="content">
    <div style="float:left"><?php echo osc_image(DIR_WS_IMAGES . 'account_notifications.gif', $osC_Language->get('my_notifications_title')); ?></div>
